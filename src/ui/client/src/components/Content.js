      ...
      return (
        <Container fluid={true}>
          <Row>
            <Col>
              <Navbar color="dark">
                <NavbarBrand href="/" style={{ color: "white" }}><img style={{ padding: "0px 10px 0px 0px" }} src="ibm bee.png" alt="ibm bee logo"></img>Bee Travels</NavbarBrand>
                <Autosuggest
          ...
          <Row>
            ...
            <Col>
              <img src={"http://localhost:4000/images/" + this.state.currentDestination.city + ", " + this.state.currentDestination.country + ".jpg"} height="500px" width="500px" alt={this.state.currentDestination.city+ ", "+ this.state.currentDestination.country}/>
            </Col>
          </Row>
        </Container>
      );
