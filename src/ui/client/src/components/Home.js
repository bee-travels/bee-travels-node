      ...
      <Container fluid={true}>
        <Row>
          <Col md={{ size: 6, offset: 3 }}>
            <div style={{ fontSize: "50px", padding: "150px 0px 0px 0px" }}><img style={{ padding: "0px 10px 50px 150px" }} src="ibm bee large.png" alt="ibm bee logo large"></img>Bee Travels</div>
            <Autosuggest
